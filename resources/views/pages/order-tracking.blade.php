            ...
            <div class="mx-auto sm:w-11/12 lg:w-3/4">
                    ...
                    <dl class="flex flex-col gap-1 sm:flex-row">
                        ...
                        <dd>
                            <ul>
                                ...
                                <li
                                    class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                    <svg class="shrink-0 size-4 me-1" width="22" height="22" viewBox="0 0 22 22"
                    ...
                    <dl class="flex flex-col gap-1 sm:flex-row">
                        ...
                        <dd>
                            <ul>
                                ...
                                <li
                                    class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                    <svg class="shrink-0 size-4 me-1" width="160" height="143"
                                        viewBox="0 0 160 143" fill="none">
                                        <path
                ...
                <div class="relative flex group gap-x-5">
                    ...
                    <div class="pb-8 grow group-last:pb-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
                            This is an excellent company and they reward their employees. It's becoming a big company
                            but it's still private, so the culture is as good as it gets at 1,000+ employees if you ask
                            me. Managers are still adapting to the growth I think, but everyone has to. Great place to
                            work.
                        </p>
                        ...
                        <div class="mt-3">
                            ...
                            <a class="block border border-gray-200 rounded-lg hover:shadow-2xs focus:outline-hidden dark:border-neutral-700"
                                ...
                                <div class="relative flex items-center overflow-hidden">
                                    <img class="absolute inset-0 object-cover w-32 h-full sm:w-48 rounded-s-lg"
                ...
                <div class="relative flex group gap-x-5">
                    ...
                    <div class="pb-8 grow group-last:pb-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-neutral-400">
                            Work in Slack is one of the beautiful experience I can do in my entire life. There are a lot
                            of interesting thing to learn and manager respect your time and your personality.
                        </p>
                    </div>
                    <!-- End Right Content -->
                </div>
                ...
                <div class="relative flex group gap-x-5">
                    ...
                    <div
                        class="relative group-last:after:hidden after:absolute after:top-8 after:bottom-2 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-200 dark:after:bg-neutral-700">
                        <div class="relative z-10 flex items-center justify-center size-6">
                            <svg class="text-gray-800 shrink-0 size-6 dark:text-neutral-200"
                    ...
                    <div class="pb-8 grow group-last:pb-0">
                        ...
                        <ul class="list-disc ms-6 mt-3 space-y-1.5">
                            ...
                            <li class="text-sm text-gray-600 ps-1 dark:text-neutral-400">
                                Developed and maintained strong client relationships through effective communication and
                                project management.
                            </li>
                            <li class="text-sm text-gray-600 ps-1 dark:text-neutral-400">
