                ...
                <div class="flex flex-col p-4 bg-white shadow-md sm:p-10 rounded-xl dark:bg-neutral-800">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="text-end">
                            ...
                            <span class="block mt-1 text-gray-500 dark:text-neutral-500">3682303</span>
                    ...
                    <div class="grid gap-3 mt-8 sm:grid-cols-2">
                        ...
                        <div class="space-y-2 sm:text-end">
                            ...
                            <div class="grid grid-cols-2 gap-3 sm:grid-cols-1 sm:gap-2">
                                ...
                                <dl class="grid sm:grid-cols-5 gap-x-3">
                                    <dt class="col-span-3 font-semibold text-gray-800 dark:text-neutral-200">Due date:
                                    </dt>
                    ...
                    <div class="mt-8 sm:mt-12">
                        ...
                        <div class="mt-2">
                            <p class="block text-sm font-medium text-gray-800 dark:text-neutral-200">example@site.com
                            </p>
                            <p class="block text-sm font-medium text-gray-800 dark:text-neutral-200">+1 (062) 109-9222
                            </p>
                        </div>
                    </div>
